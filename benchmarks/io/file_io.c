...
int main( int argc, char *argv[] )
{
     ...
     *p_char  = move around the file
     input_file[MAX_FILE_LEN]  =  the name of the file that is being read for iteration x
     output_file[MAX_FILE_LEN]  =  the name of the file that is being written for iteration x
    ...
    for (i = 0 ;  i <= 1023 ; i++)
    {
        ...
        /* write the output */
        snprintf(output_file, sizeof(output_file) , "output-%s.%ld",host_name , i);
